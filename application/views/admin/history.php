                      ...
                      <table id="demo-dynamic-tables-2" class="table table-middle nowrap">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                            <?php if ($sts == 'Upcoming') { ?>
                              <a class="btn btn-xs btn-danger" href="<?php echo base_url() . 'admin/cancel_booking/' . $hist->id_booking . '/' . $hist->id_det_booking;?>" >Cancel</a>
                              <a class="btn btn-xs btn-primary" href="<?php echo base_url() . 'admin/reschedule/0/' . $hist->id_booking . '/' . $hist->id_det_booking;?>">Reschedule</a>
                            <?php } else { ?>
