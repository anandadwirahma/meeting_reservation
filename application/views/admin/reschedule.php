            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-8">
                  ...
                  echo form_open('admin/reschedule',$atributes);
                  foreach ($dt_book as $dt) :
                  ?>
                    <input class="form-control" type="hidden" value="<?php echo $id_det_booking; ?>" name="id_det_booking">
                    <input class="form-control" type="hidden" value="<?php echo $id_booking; ?>" name="id_booking">
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="form-control-1">Tanggal</label>
                          <div class="col-sm-6">
                            <div class="input-with-icon">
                              <input class="form-control" type="text" value="<?php echo $dt->tgl; ?>" name="tanggal" data-provide="datepicker" required>
                       ...
                       <div class="form-group">
                        <label class="col-sm-3 control-label" for="form-control-3">Jumlah Peserta</label>
                          <div class="col-sm-6">
                            <input id="form-control-3" class="form-control" type="number" value="<?php echo $dt->tot_psrta; ?>" name="jml_psrta" placeholder="Jumlah Peserta" required>
                      ...
                      <div class="form-group">
                        <label class="col-sm-3 control-label" for="form-control-1">Jam</label>
                          <div class="col-sm-3">
                            <div class="input-with-icon">
                              <input id="form-control-2" class="form-control" name="start_time" type="text" value="<?php echo $dt->jam_mulai; ?>" data-inputmask="'alias': 'hh:mm'" required>
                              <span class="help-block">Input start time (hh:mm).</span>
                            </div>
                          </div>
                         <div class="col-sm-3">
                            <div class="input-with-icon">
                              <input id="form-control-2" class="form-control" name="end_time" type="text" value="<?php echo $dt->jam_akhir; ?>" data-inputmask="'alias': 'hh:mm'" required>
