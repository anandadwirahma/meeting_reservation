                  ...
                  <div class="demo-form-wrapper">
                    ...
                    <?php foreach ($data as $row) : ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <a class="btn btn-primary btn-block" href="<?php echo base_url() . 'admin/edit_profil/' .$row->id_karyawan; ?>">Edit Profile</a>
                        </div>
                        <div class="col-sm-3">
                          <a class="btn btn-info btn-block" href="<?php echo base_url() . 'admin/ubah_password/' .$row->id_karyawan; ?>">Ubah Password</a>
                        </div>
                      </div>
                    <?php endforeach ;?>  
                    </form>
