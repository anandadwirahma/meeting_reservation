            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-8">
                  ...
                  echo form_open('admin/edit_ruang_exc',$atributes);
                  ...
                  ?>
                      ...
                      <div class="form-group">
                        <label class="col-sm-3 control-label" for="form-control-3">Lokasi</label>
                          <div class="col-sm-6">
                            <input id="form-control-3" class="form-control" type="number" value="<?php echo $row->lokasi; ?>" name="lokasi" placeholder="Lokasi Ruangan" required>
                          <span class="help-block">Input Lokasi Ruangan.</span>
                          </div>
                      </div>
                      <div class="form-group">
