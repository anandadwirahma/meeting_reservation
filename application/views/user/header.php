...
<link href="<?php echo base_url() ?>asset/css/demo.min.css" rel="stylesheet" type="text/css">
...
<div class="layout-header">
	<div class="navbar navbar-default">
		<div class="navbar-header">
			<a href="<?php echo base_url() ;?>user"><img src="<?php echo base_url() ?>asset/img/solusi247.png" style="width:100%; max-width:250px;"></a>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown hidden-xs">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						<li>
							<a href="<?php echo base_url() ;?>user/lihat_profil">Profile</a>
						</li>
						<li>
			...
			<div class="custom-scrollbar">
				...
				<ul class="sidenav">
					...
					<li class="sidenav-item">
						<a href="<?php echo base_url() ;?>user/lihat_profil" aria-haspopup="true">
					...
					<li class="sidenav-item has-subnav">
						...
						<ul class="sidenav-subnav collapse">
							...
							<li>
								<a href="<?php echo base_url() ;?>user">Info Ketersedian</a>
							</li>
							<li>
								<a href="<?php echo base_url() ;?>user/history">Jadwal Booking</a>
							</li>
						</ul>
					</li>
				</ul>
