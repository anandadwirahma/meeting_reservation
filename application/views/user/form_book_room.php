            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-8">
                  ...
                  echo form_open('user/book_room_exc',$atributes);
                  ?>
                      ...
                      <div class="form-group">
                        <label class="col-sm-3 control-label" for="form-control-1">Ruangan</label>
                         <div class="col-sm-6">
                          ...
                          <?php 
                          // $status = array();
                          // foreach ($status_room as $sts_room) :
                          //   $status[] = $sts_room->id_ruang;
                          // endforeach;
                          //echo count($status_room);exit;
                          
                          foreach ($ruang as $room) :           
                          ?>
                            <option value="<?php echo $room->id_ruang ?>">
                              <?php 
                                // for ($x = 0; $x < count($status_room); $x++) {
                                //   if ($room->id_ruang == $status[$x]){
                                //     $status_ruangan = 'NOT AVAILABLE';
                                //   }else{
                                //     $status_ruangan = 'AVAILABLE';
                                //   }
                                // }
                                echo "$room->nama_ruang";
                              ?>
                            </option>
                          <?php endforeach; ?>
                          </select>
